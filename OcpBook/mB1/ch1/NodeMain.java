...
class AnimalList<T> implements Iterable<T> { 
	Node<T> head, tail; 
...
class ListIterator<T> implements Iterator<T> { 
	...
	public ListIterator(AnimalList<T> list) 
	{ 
	...
	public void remove() 
	{ 
		throw new UnsupportedOperationException("currently we are not supporting it"); 
	} 
} 
...
class NodeMain { 
	...
	{ 
		// Create Linked List 
		AnimalList<String> myList = new AnimalList<>(); 
